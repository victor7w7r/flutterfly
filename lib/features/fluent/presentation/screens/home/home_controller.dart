...
final class HomeController {
  ...
  Color backSelector(final String color) => switch (color) {
  ...
  Color borderSelector(final String color) => switch (color) {
...
@riverpod
HomeController homeController(final HomeControllerRef ref) =>
    HomeController(ref);
