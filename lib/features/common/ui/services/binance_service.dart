...
typedef QueryBinanceBuilder = BaseQueryBuilder<IList<Binance>, FetchException>;
typedef QueryBinance = Query<IList<Binance>, FetchException>;
...
final class BinanceService {
  ...
  Future<List<Binance>> getCurrencies() async => (await _getCurrenciesUseCase())
