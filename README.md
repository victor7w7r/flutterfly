...
A very simple template for Flutter with essential packages
...
- provider: A provider wrapper to make them easier to use and more reusable.
- shared_preferences: Shared preferences plugin.
